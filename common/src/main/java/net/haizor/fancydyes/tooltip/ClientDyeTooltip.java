...
public record ClientDyeTooltip(DyeTooltip tooltip) implements ClientTooltipComponent {
    ...
    private Component getText() {
        return Component.translatable("gui.tooltip.dye").append("    ").append(FancyDye.getItem(tooltip.dye()).getDescription()).withStyle(ChatFormatting.GRAY);
    }
    ...
    public void renderImage(Font font, int x, int y, PoseStack poseStack, ItemRenderer itemRenderer, int k) {
        ...
        int l = font.width(Component.translatable("gui.tooltip.dye").append(" "));
